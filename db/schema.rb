...
ActiveRecord::Schema.define(version: 2020_05_07_174741) do
  ...
  create_table "cart_items", force: :cascade do |t|
    ...
    t.index ["listing_id"], name: "index_cart_items_on_listing_id", unique: true
    t.index ["user_id"], name: "index_cart_items_on_user_id", unique: true
  end
